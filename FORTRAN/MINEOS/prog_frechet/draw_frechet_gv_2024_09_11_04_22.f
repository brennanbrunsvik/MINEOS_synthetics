...
cad end of addition
c brb
      integer start_time, end_time, clock_rate, JUNK
      real elapsed_time
c end brb
...
5     print*,' Enter name of input frechet file'
      ...
      print*, 'dT: ', elapsed_time, ' seconds. "Enter name of input frechet file"'

c      brb addition
C      b_file = 'starting' 
C      do while (b_file .NE. 'end') 
c     brb 11 is output file. 2 is input file. 
      do
        print*,' Enter name of output file, or end to stop. '
        read(*,'(a)')b_file 
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot G'
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot E'


c ### brb Load input file. Shouldn't this only be done once? 
...
c
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot B. Loaded stuff. '
c ###    brb Done loading input file? 
...
c     set up integration parameters and constants
    ...
    !     end do
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot B.1. Loaded stuff. '
...
c Slow
     ...
     &              nn,ll,w,qq,gv,cv,(buf(kk), kk = 1, kind)
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot B.1.b '
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot B.2. Loaded stuff. '
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot B.3. Loaded stuff. '
     ...
     &    nnsave(imodefnd),llsave(imodefnd),p
        ...
        call system_clock(end_time)
        elapsed_time = real(end_time - start_time) / real(clock_rate)
        print*, 'dT: ', elapsed_time, ' seconds. Spot C'
...
c Slow
     ...
     &              nn,ll,w,qq,gv,cv,(buf(kk), kk = 1, kind)
          ...
          ! call system_clock(end_time)
          ! elapsed_time = real(end_time - start_time) / real(clock_rate)
          ! print*, 'dT: ', elapsed_time, ' seconds. Spot C.1'
...
c
     ...
     &             + buf(k2+j)*dbetah(ind+j)
            ...
            call system_clock(end_time)
            elapsed_time = real(end_time - start_time) / real(clock_rate)
            print*, 'dT: ', elapsed_time, ' seconds. Spot D'
c
ccc write out
