...
%        pause;
    ...
    %brb2024/05/31 I got here trying to get Josh's mineos to work with one
    %of our output mineos model files. Maybe look more in
    %~/Documents/UCSB/ENAM/THBI_ENAM/matlab_to_mineos/safekeeping.
    % 
    % mineos_qcorrectphv
